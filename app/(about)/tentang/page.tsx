  ...
  return (
    <main className="bg-sky text-white">
      ...
      <section className="w-full bg-white text-black text-justify flex justify-center items-center">
        <section className="w-1/2 mx-auto grid grid-cols-1 lg:grid-cols-2 justify-center items-center">
          <ProfileCard
            name="Donald Akbar"
            grid={3}
      ...
      <section className="w-full py-16 bg-white text-black text-justify flex flex-col justify-center items-center">
        ...
        <section className="w-10/12 mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <ProfileCard
            name="Emil Dharma"
            grid={4}
